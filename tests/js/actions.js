...
// =======================================================================================================================================================================
        ...
        $('.remove').click(function()
        {
            ...
            vectorSource.removeFeature(vectorSource.getFeatureById(new_id));
            features_list.splice(features_list.indexOf(vectorSource.getFeatureById(new_id)), 1);
        ...
        $(".ui.checkbox#row").checkbox({
            onChecked: function() {
                ...
                vectorSource.addFeature(features_list[features_list.length - 1][0]);
                vectorSource.addFeature(features_list[features_list.length - 1][1]);
                lineSource.addFeature(line_list[line_list.length - 1]);
            ...
            onUnchecked: function() {
                ...
                vectorSource.removeFeature(vectorSource.getFeatureById(index+'0'));
                vectorSource.removeFeature(vectorSource.getFeatureById(index+'1'));
                lineSource.removeFeature(lineSource.getFeatureById(index));
                features_list.splice(features_list.indexOf(vectorSource.getFeatureById(index)), 1);
                line_list.splice(line_list.indexOf(lineSource.getFeatureById(index)), 1);
            }
        });
        ...
        $(".ui.checkbox#urow").checkbox({
            onChecked: function() {
                ...
                circleSource.addFeature(circle_list[circle_list.length - 1]);
                vectorSource.addFeature(features_list[features_list.length - 1]);
            ...
            onUnchecked: function() {
                index = $(this).val();
                vectorSource.removeFeature(vectorSource.getFeatureById(index));
                circleSource.removeFeature(circleSource.getFeatureById("circle"+index));
                features_list.splice(features_list.indexOf(vectorSource.getFeatureById(index)), 1);
                circle_list.splice(circle_list.indexOf(vectorSource.getFeatureById("circle"+index)), 1);
            }
        });
        ...
        var map = new ol.Map({
            ...
            layers: [
                ...
                lineLayer, circleLayer, vectorLayer],
            view: new ol.View({
